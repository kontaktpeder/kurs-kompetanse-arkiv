    ...
    <>
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-xs sm:text-sm font-semibold uppercase tracking-wider">
          ...
          <span className="flex items-center gap-2">✓ Norsk · Engelsk · Tegnspråk</span>
          <span className="flex items-center gap-2">✓ For bedrifter og privatpersoner</span>
          <span className="flex items-center gap-2">✓ Praktisk erfaring fra bygg og industri</span>
        </div>
      </section>
      ...
      <section className="py-20 px-4 border-t border-border">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={stat.label}>
              <div className="text-5xl sm:text-4xl lg:text-5xl font-bold text-primary leading-none mb-2" style={{ fontFamily: 'Oswald, sans-serif' }}>
                {stat.num}
              </div>
              ...
              {courses.map((course: any) => {
                ...
                return (
                  <Link key={course.id} to={`/kurs/${course.slug}`} className="group">
                    <div className="bg-card border border-border hover:border-primary/60 transition-all h-full overflow-hidden relative flex flex-col">
                      {course.image_url && (
                      ...
                      <div className="p-3 sm:p-6 flex flex-col flex-1">
                        ...
                        <p className="hidden sm:block text-muted-foreground text-sm mb-4">{course.short_description}</p>
